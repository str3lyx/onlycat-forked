...
class TokenTypes(Enum):
    EMAIL_ACTIVATION = (
        UserActions.ACTIVATION_REQUEST,
        UserActions.ACTIVATION_SUCCESS,
        TokenGenerator("email-activation-token-generator"),
    )
    PASSWORD_RECOVER = (
        UserActions.PASSWORD_RESET_REQUEST,
        UserActions.PASSWORD_RESET_SUCCESS,
        TokenGenerator("password-reset-token-generator"),
    )
